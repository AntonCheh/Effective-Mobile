package restApi.apiTests.booker;
...
public class TestBookerSimple {
    ...
    public void testGetBookingIds() {
        ...
        Assert.assertTrue(bookingIds.stream().allMatch(id -> id != null),
